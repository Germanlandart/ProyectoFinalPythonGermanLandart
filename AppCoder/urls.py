...
urlpatterns = [
    ...
    path("fantasia/book/<int:pk>/comentariosf", ComentarioF.as_view(template_name="AppCoder/comentariof.html"), name='ComentarioFantasia'),
    path("cienciaficcion/book/<int:pk>/comentarioscf", ComentarioCF.as_view(template_name="AppCoder/comentariocf.html"), name='ComentarioCienciaFiccion'),
